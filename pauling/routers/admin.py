...
from pauling.db.models import User, Role
from pauling.db.repositories import UserRepository
from pauling.auth.sessions import get_current_user_from_session, generate_csrf_token, set_csrf_cookie, validate_csrf_token
from pauling.auth.roles import require_roles, get_highest_role, get_user_role_names
from pauling.config import settings, TEMPLATES_DIR
from pauling.models.admin import (
...
async def admin_dashboard(
    ...
    response = templates.TemplateResponse(request, "admin/dashboard.html", context)
...
async def admin_users_page(
    ...
    response = templates.TemplateResponse(request, "admin/users.html", template_context)
    set_csrf_cookie(response, csrf_token)
    return response
